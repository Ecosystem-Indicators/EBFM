...
for (iYear in minYear:maxYear) {
    ...
    nodes <- rownames(dietData) ## check this with Beth. if this TRUE need to be put out of the loop
    ## Calculate Degree in and Degree out
    gg <- network(dietData, directed=TRUE, loops=TRUE, multiple=TRUE, vertex.names=nodes)  # Create network from dietData
